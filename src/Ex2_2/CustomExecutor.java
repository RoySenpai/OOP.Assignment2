...
public class CustomExecutor extends ThreadPoolExecutor {
     ...
     */
    public static final PriorityBlockingQueue<Runnable> BlockingQueue = new PriorityBlockingQueue<>(
                                                                        MINIMUM_POOLSIZE,
    ...
    public String toString() {
        return "Queue size: " + BlockingQueue.size() + "; Current max priority: " + this.currentMaxPriority;
    }
}
